    ...
    <footer id="site-footer" className="bg-ink text-paper px-gutter pt-[clamp(36px,4vw,56px)] pb-0 border-t border-t-on-dark-14">
      <div className="grid grid-cols-[minmax(280px,1.3fr)_1fr_1fr_0.8fr] gap-[clamp(28px,3.4vw,56px)] pb-[clamp(32px,3.6vw,48px)] max-[1039px]:grid-cols-2 max-[759px]:grid-cols-1">
        ...
        <div className={COL}>
          ...
          <a href="/pdf/Lemon-and-Soda-UK-Terms-and-Conditions.pdf" target="_blank" rel="noopener noreferrer" className={LINK}>
            Terms &amp; conditions
          </a>
          <a href="/pdf/Lemon-and-Soda-UK-Privacy-Policy.pdf" target="_blank" rel="noopener noreferrer" className={LINK}>
            Privacy policy
          </a>
          <a href="/pdf/Lemon-and-Soda-UK-Cookie-Policy.pdf" target="_blank" rel="noopener noreferrer" className={LINK}>
            Cookies
          </a>
        </div>
        <div className={COL}>
